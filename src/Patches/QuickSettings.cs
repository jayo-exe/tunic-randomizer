    ...
    public class QuickSettings : MonoBehaviour
    {
        ...
        private static void ArchipelagoQuickSettingsWindow(int windowID)
        {
            ...
            if (TunicRandomizer.Settings.VNyanSettings.Enabled)
            {
                ...
                bool ClearVNyanAddress = GUI.Button(new Rect(190f * guiScale, y, 75f * guiScale, 30f * guiScale), "Clear");
        ...
        private static void AdvancedLogicOptionsWindow(int windowID)
        {
            ...
            y += 40f * guiScale;
            TunicRandomizer.Settings.AlternateLogic = GUI.Toggle(new Rect(10f * guiScale, y, 400f * guiScale, 30f * guiScale), TunicRandomizer.Settings.AlternateLogic, "Use Alternate Randomization Logic");
            y += 30f * guiScale;
            GUI.Label(new Rect(10f * guiScale, y, 400f * guiScale, 30f * guiScale), $"<color=#ff0000>Does not work with ER or Ladder Shuffle</color>");
            y += 40f * guiScale;
        ...
        private static void ArchipelagoConfigEditorWindow(int windowID)
        {
            ...
            GUI.Label(new Rect(10f * guiScale, 250f * guiScale, 300f * guiScale, 30f * guiScale), $"Port: {textWithCursor((editingPort ? (showPort ? stringToEdit : new string('*', stringToEdit.Length)) : (showPort ? TunicRandomizer.Settings.ConnectionSettings.Port.ToString() : new string('*', TunicRandomizer.Settings.ConnectionSettings.Port.ToString().Length))), stringCursorPosition, editingPort)}");
            ...
            GUI.Label(new Rect(10f * guiScale, 350f * guiScale, 300f * guiScale, 30f * guiScale), $"Password: {textWithCursor((showPassword ? TunicRandomizer.Settings.ConnectionSettings.Password : new string('*', TunicRandomizer.Settings.ConnectionSettings.Password.Length)), stringCursorPosition, editingPort)}");
